...
public class ProfileEditActivity extends AppCompatActivity {
    ...
    private void uploadImage(){
        ...
        //image path and name, and use uid to replace previous
    ...
    private void pickImageCamera(){
        ...
        cameraAcitivtyResultLauncher.launch(intent);
    }
    ...
    private void pickImageGallery(){
        ...
        galleryAcitivtyResultLauncher.launch(intent);

    }

    private ActivityResultLauncher<Intent> cameraAcitivtyResultLauncher = registerForActivityResult(
    ...
    private ActivityResultLauncher<Intent> galleryAcitivtyResultLauncher = registerForActivityResult(
            new ActivityResultContracts.StartActivityForResult(),
            new ActivityResultCallback<ActivityResult>() {
                @Override
                public void onActivityResult(ActivityResult result) {
